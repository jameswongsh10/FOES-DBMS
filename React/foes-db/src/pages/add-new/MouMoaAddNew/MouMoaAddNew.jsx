...
const MouMoaAddNew = () => {
    ...
    useEffect(() => {
        fetch(`${URL}/api/getMOUMOAColumns`, {
            ...
            .then(data => {
                const filters = ["id", "country", "institution", "signed_date", "due_date", "area_of_collab", "progress", "type_of_agreement", "isActive", "research", "teaching", "exchange", "collab_and_partnerships", "mutual_extension", "created_at", "updated_at"];
