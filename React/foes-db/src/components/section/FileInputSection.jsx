            ...
            <div className="form">
                <div className="formInput">
                    ...
                    <select name="type" id="type"
                            defaultValue={!props.isNew && props.obj.type === "Professional Qualification" ? "Professional Qualification" : "Professional Membership"}
                            ref={typeInput}>
                ...
                <Button className='section-btn' variant='contained' color='success'
                        onClick={props.isNew === true ? onSaveHandler : onUpdateHandler} disabled={props.isNew && !file}>Save</Button>
